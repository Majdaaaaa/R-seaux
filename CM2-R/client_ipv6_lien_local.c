...
#define ADDR "fe80::4849:43ff:fe49:79bf"  //adresse du serveur sur lien local
#define INTERF 0
...
int main(){
	...
	//address_sock.sin6_scope_id = INTERF;
	address_sock.sin6_scope_id = if_nametoindex("eth0");
	printf("interface = %d\n", address_sock.sin6_scope_id); 
